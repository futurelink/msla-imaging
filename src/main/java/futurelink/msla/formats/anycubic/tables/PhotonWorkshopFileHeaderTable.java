...
public class PhotonWorkshopFileHeaderTable extends PhotonWorkshopFileTable {
    ...
    public static class Fields implements MSLAFileBlockFields {
        ...
        @MSLAFileField(order = 8) @MSLAOption(MSLAOptionName.LiftHeight) private Float LiftHeight = DefaultLiftHeight;
        ...
        @MSLAFileField(order = 15) @MSLAOption(MSLAOptionName.Weight) private Float WeightG = 0.0F;
        @MSLAFileField(order = 16) @MSLAOption(MSLAOptionName.Price) private Float Price = 0.0F;
        ...
        @MSLAFileField(order = 18) @MSLAOption(MSLAOptionName.LayerSettings) private Integer PerLayerOverride = 0; // boolean (80 - true, 00 - false)
        @MSLAFileField(order = 19) @MSLAOption(MSLAOptionName.PrintTime) private Integer PrintTime = 0;

        /* Version 2.4 fields */
        @MSLAFileField(order = 20) @MSLAOption(MSLAOptionName.TransitionLayersCount) private Integer TransitionLayerCount = 0;
        @MSLAFileField(order = 21) @MSLAOption(MSLAOptionName.TransitionLayersType) private Integer TransitionLayerType = 0;
        @MSLAFileField(order = 22) @MSLAOption(MSLAOptionName.AdvancedMode) private Integer AdvancedMode = 0; /// 0 = Basic mode | 1 = Advanced mode which allows TSMC

        /* Version 2.5 fields */
        @MSLAFileField(order = 23) @MSLAOption(MSLAOptionName.Grey) private Short Grey = 0;
        @MSLAFileField(order = 24) @MSLAOption(MSLAOptionName.BlurLevel) private Short BlurLevel = 0;
        @MSLAFileField(order = 25) @MSLAOption(MSLAOptionName.ResinType) private Integer ResinType = 0;

        /* Version 2.6 fields */
        // boolean, when true, normal exposure time will be auto set, use false for traditional way
        @MSLAFileField(order = 26) @MSLAOption(MSLAOptionName.IntelligentMode) private Integer IntelligentMode = 0;
