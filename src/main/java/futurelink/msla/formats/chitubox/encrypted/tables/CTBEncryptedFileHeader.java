...
import futurelink.msla.formats.chitubox.tables.CTBFileBlock;
...
public class CTBEncryptedFileHeader extends CTBFileBlock {
    ...
    public static final Integer MAGIC_CTB_ENCRYPTED = 0x12FD0107;
    ...
    public static class Fields implements MSLAFileBlockFields {
        ...
        public void setVersion(Integer version) throws MSLAException {
            ...
            if ((Magic != null) && !Objects.equals(Magic, MAGIC_CTB_ENCRYPTED))
                throw new MSLAException("Version is not valid for magic number");
            else {
                Version = version;
                Magic = MAGIC_CTB_ENCRYPTED;
            }
        }
