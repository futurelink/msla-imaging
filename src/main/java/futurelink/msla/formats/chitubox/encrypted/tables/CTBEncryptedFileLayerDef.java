...
@Getter
public class CTBEncryptedFileLayerDef implements MSLAFileBlock {
    ...
    public static class Fields implements MSLAFileBlockFields {
        ...
        @MSLAFileField(order = 4) @Getter private Integer LayerDataOffset;
        @MSLAFileField(order = 5) private Integer PageNumber;
        @MSLAFileField(order = 6) private Integer DataLength;
        ...
        @MSLAFileField(order = 21) private final Integer Unknown6 = 0;
    }

    public CTBEncryptedFileLayerDef() { fileFields = new Fields(); }
